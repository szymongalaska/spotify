...
class AppController extends Controller
{
    ...
    public function beforeFilter(\Cake\Event\EventInterface $event)
    {
        ...
        if (!\in_array($this->getRequest()->getParam('action'), ['login', 'logout', 'cron', 'loginAsGuest', 'cronAvailableAndUnavailableTracks']) && !\in_array($this->getRequest()->getParam('controller'), ['Pages'])) {
